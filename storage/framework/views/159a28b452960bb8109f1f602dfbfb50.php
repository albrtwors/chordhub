<div>
    ...
    <!--[if BLOCK]><![endif]--><?php if(
        ...
        <div wire:loading.hide wire:target="selectedImage" class="d-flex justify-content-center my-3">
            <img width="200px" height="200px" src="<?php echo e($selectedImage->temporaryUrl() ?? 'null'); ?>" alt=""
                class="rounded-circle">
        </div>
    <?php elseif($existingImageUrl): ?>
        <div class="d-flex justify-content-center my-3">
            <img width="200px" height="200px" src="<?php echo e($existingImageUrl); ?>" alt="" class="rounded-circle">
        </div>
...
<?php /**PATH /home/albrt/Documents/Universidad 🏫/ChordhubV3/resources/views/livewire/form/image-form.blade.php ENDPATH**/ ?>