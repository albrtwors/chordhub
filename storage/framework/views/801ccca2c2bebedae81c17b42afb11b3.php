...
unset($__defined_vars, $__key, $__value); ?> 
  ...
  <a class="song-card-anchor" href="<?php echo e(route('chordsCreate', $id)); ?>">
  ...
  <a class="song-card-anchor" href="<?php echo e(route('chordsEditSong', $id)); ?>">
    <div class="d-flex flex-column gap-3 align-items-center">
        <img src="<?php echo e($image); ?>" style="width:150px;height:150px;border-radius:30px" alt="">
        <div class="flex-column d-flex text-center align-items-center">
            <h4 class="fw-bold">
  ...
  <?php elseif($type=="delete"): ?>
    <a class="song-card-anchor" href="<?php echo e(route('chordsDeleteIndex', $id)); ?>">
    <div class="d-flex flex-column gap-3 align-items-center">
  ...
  <?php else: ?>
    <a class="song-card-anchor" href="<?php echo e(route('chord.versions', $id)); ?>">
        <div class="d-flex flex-column gap-3 align-items-center">
            <img src="<?php echo e($image); ?>" style="width:150px;height:150px;border-radius:30px" alt="">
            <div class="flex-column d-flex text-center align-items-center">
                <h4 class="fw-bold">
...
<?php /**PATH /home/albrt/Documents/Universidad 🏫/ChordhubV3/resources/views/components/chord/chord-card.blade.php ENDPATH**/ ?>