...
Puente
                            ...
                            <div class="input-group mt-3">
                                <input type="text" value="<?php echo e($song->name); ?>" class="form-control bg-light small"
                            ...
                            <div class="mt-3">
                                <div class="input-group mt-3">
                                    <input type="text" value="<?php echo e($song->author->name); ?>" name="author"
                        ...
                        <div class="mt-3 d-flex justify-content-center">
                            <input class="songinput" value="<?php echo e($song->keywords); ?>" type="text" name="keywords"
                                id="">
                        </div>

                        <div class="mt-3">
                            <label for="collab">Participación Colaborativa</label>
                            <input <?php echo e($song->collab ? 'checked' : ''); ?> type="checkbox" name="collab" id=""
                                value="1">
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mrrobot/coding/ChordhubV2/resources/views/modules/Song/modify_song.blade.php ENDPATH**/ ?>