...
<h3 class="text-start ms-5 pb-3  ">
    ...
    <div class="d-flex justify-content-center container ">
        ...
        <div class="div">
                ...
                <div class="input-group">
                    <input type="text" id="search_songs" class="form-control bg-light border-0 small" placeholder="Buscar..."
    ...
    <div id="song_row" class="ms-5 row justify-content-center">
                ...
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        ...
                        <p><?php echo e($song->author); ?></p>
                           ...
                           <button type="button" data-id="<?php echo e($song->id); ?>" onclick="songDelete(this)" class="btn btn-danger">Eliminar</button>
...
<script type="module" src="<?php echo e(asset("js/Search/SearchSongDelete.js")); ?>"></script>
<?php $__env->stopSection(); ?>


  
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Chordhub\resources\views/modules/Song/delete.blade.php ENDPATH**/ ?>