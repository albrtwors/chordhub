...
<?php endif; ?>
            ...
            <div style="" class="d-flex gap-3">
                <!--[if BLOCK]><![endif]--><?php if(count($practice->userParticipants)!=0): ?>
                ...
                <?php else: ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = explode(',',$practice->participants); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
...
</div><?php /**PATH /home/notalber/Documents/Coding/ChordhubV3/resources/views/livewire/practices/own-practices.blade.php ENDPATH**/ ?>