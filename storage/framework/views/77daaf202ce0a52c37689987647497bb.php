...
<div class="row">
    <input type="text" id="songjson" value="<?php echo e($song->chord->structure ?? $song->structure); ?>" class="d-none">
    ...
    <div class="col-xl-5 col-md-12 col-md-12 col-sm-12 d-flex me-5 justify-content-end">
        <div class="d-flex my-3">
            <h6 class="me-1 mt-2">Subido por: <?php echo e($user->name); ?> </h6> <img class="img-profile rounded-circle" width="32" height="32" src="<?php echo e($user->image->url ?? "https://cdn-icons-png.flaticon.com/512/3809/3809073.png"); ?>"></img>
        </div>
    </div>

</div>

<form id="delform" class="d-flex justify-content-center" action="<?php echo e(route('acordes.destroy', $song->id)); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mrrobot/coding/ChordhubV2/resources/views/modules/Chord/edit.blade.php ENDPATH**/ ?>