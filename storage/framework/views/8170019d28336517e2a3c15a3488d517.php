...
<div>
    <!--[if BLOCK]><![endif]--><?php if($paginator->hasPages()): ?>
        <nav class="d-flex justify-items-center justify-content-between">
            ...
            <div class="d-none gap-3 flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
                <div>
...
<?php /**PATH /home/albrt/Documents/Universidad 🏫/ChordhubV3/resources/views/vendor/livewire/bootstrap.blade.php ENDPATH**/ ?>