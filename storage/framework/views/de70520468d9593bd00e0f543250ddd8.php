...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('templates/landing/vendors/owl-carousel/css/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('templates/landing/vendors/owl-carousel/css/owl.theme.default.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('templates/landing/vendors/mdi/css/materialdesignicons.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('templates/landing/vendors/aos/css/aos.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('templates/landing/css/style.min.css')); ?>">
    ...
    <link href="<?php echo e(asset('css/dashstyles.css')); ?>" rel="stylesheet"
        integrity="sha384-LN+7fdVzj6u52u30Kp6M/trliBMCMKTyK833zpbD+pXdCLuTusPj697FH4R/5mcr" crossorigin="anonymous">
</head>
...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
    ...
    <div class="banner">
        <div class="container">
            ...
            <div>
                <a href="<?php echo e(route('login')); ?>"> <button class="btn btn-primary mr-1">Inicia sesión</button></a>
                <a href="<?php echo e(route('sign')); ?>"><button class="btn btn-primary ">Crea una cuenta</button></a>
            </div>
            <img src="<?php echo e(asset('BD-simple-landing-page-ea1c3f39a22f/images/Group171.svg')); ?>" alt=""
                class="img-fluid">
        </div>
    </div>
                            ...
                            <div class="card-body p-0">
                                <div class="bg-primary text-center card-contents">
                                    <div class="card-image">
                                        <img src="<?php echo e(asset('BD-simple-landing-page-ea1c3f39a22f/images/Group95.svg')); ?>"
                        ...
                        <div class="card color-cards">
                            <div class="card-body p-0">
                                <div class="bg-warning text-center card-contents">
                                    <div class="card-image">
                                        <img src="<?php echo e(asset('BD-simple-landing-page-ea1c3f39a22f/images/Group108.svg')); ?>"
                                            class="case-studies-card-img" alt="">
                                    </div>
                                    <div class="card-desc-box d-flex align-items-center justify-content-around">
                                        <div>
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <script src="<?php echo e(asset('templates/landing/vendors/jquery/jquery.min.js')); ?>"></script>
            <script src="<?php echo e(asset('templates/landing/vendors/bootstrap/bootstrap.min.js')); ?>"></script>
            <script src="<?php echo e(asset('templates/landing/vendors/owl-carousel/js/owl.carousel.min.js')); ?>"></script>
            <script src="<?php echo e(asset('templates/landing/vendors/aos/js/aos.js')); ?>"></script>
            <script src="<?php echo e(asset('templates/landing/js/landingpage.js')); ?>"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\ChordhubV3\resources\views/landing/landing.blade.php ENDPATH**/ ?>