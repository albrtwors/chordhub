...
<?php $__empty_1 = true; $__currentLoopData = $songs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $song): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="d-flex">
                    ...
                    <div class="ms-3">
                        ...
                        <a href="<?php echo e(route("song_mod", $song->id)); ?>"><button class="btn btn-success">Modificar</button></a>
                    </div>
                </div>
                </div>
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Chordhub\resources\views/modules/Song/modify.blade.php ENDPATH**/ ?>