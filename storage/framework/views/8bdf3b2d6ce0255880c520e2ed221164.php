<?php $__env->startSection('content'); ?>
	<div class="limiter">
	    <div style="background-color: #ffff" class="container-login100">
	        <div style="background-color:#fff" class="wrap-login100">
	            ...
	            <form action="<?php echo e(route('restore_code_validate')); ?>" id="emailform">
	                <?php echo csrf_field(); ?>
    ...
    <script type="module" src="<?php echo e(asset('js/Auth/RestoreCode.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.logsign', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ChordhubV2\resources\views/modules/Auth/restore_code.blade.php ENDPATH**/ ?>