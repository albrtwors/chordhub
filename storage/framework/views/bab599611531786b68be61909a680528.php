...
<?php $component = App\View\Components\App\PageHeader::resolve(['text' => 'Canciones'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1939914301-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ChordhubV3\resources\views/modules/Song/songs.blade.php ENDPATH**/ ?>