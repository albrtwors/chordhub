...
<div class="row d-flex m-xl-0 m-md-5 m-5 justify-content-center">
    <div class="border-left-xl-primary col-xl-4 col-md-10 d-flex justify-content-center">
        <form action="<?php echo e(route("song_create_validate")); ?>" id="songform">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make("layouts.app", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Chordhub\resources\views/modules/Song/create.blade.php ENDPATH**/ ?>