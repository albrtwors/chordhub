...
<div class="row d-flex justify-content-center">
    ...
    <div class="col-xl-4 col-md-12 col-12 ms-5">
        ...
        <div class="list-group me-xl-0 me-md-5 me-5" id="addedSongs">
            ...
            <li class="list-group-item " id="liTemplate">
                ...
                <div class="d-flex justify-content-end">
                    <button data-id="<?php echo e($son->id); ?>" id="deleteButton" onclick="ListInstance.deleteSong(this)" class="btn btn-danger songbut">
                        <i class="fas fa-trash"></i>
                    </button>
                </div>
        ...
        <div class="input-group mt-3 w-75" >
            <input data-id="<?php echo e($list->id); ?>" type="text" class="form-control bg-light small" name="list_name" id="list_name"
    ...
    <div class="col-xl-6">
        ...
        <ul class="list-group" id="songsToAdd">
            ...
            <li value="<?php echo e($song->name); ?>" data-id="<?php echo e($song->id); ?>" class="list-group-item d-flex"><?php echo e($song->name); ?><button onclick="ListInstance.addSong(this.parentNode.getAttribute('value'), this.parentNode.getAttribute('data-id'))" class="ms-auto btn btn-success"> + </button></li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Chordhub\resources\views/modules/List/modify_list.blade.php ENDPATH**/ ?>