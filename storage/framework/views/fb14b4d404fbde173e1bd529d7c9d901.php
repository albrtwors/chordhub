<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('songs.edit')): ?>
        <!-- Nav Item - Tables -->
        <li class="nav-item <?php echo e(request()->is('admin/comentarios') ? 'active' : ''); ?> ">
...
<!-- End of Sidebar -->
<?php /**PATH /home/mrrobot/coding/ChordhubV2/resources/views/components/navbar.blade.php ENDPATH**/ ?>