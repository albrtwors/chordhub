...
<head>
    ...
    <link href="{{asset("templates/userpanel/vendor/fontawesome-free/css/all.min.css")}}" rel="stylesheet" type="text/css">
    <link
    ...
    <link href="{{asset("templates/userpanel/css/sb-admin-2.min.css")}}" rel="stylesheet">
    <link href="{{asset("templates/userpanel/css/dashstyles.css")}}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <!-- Divider -->
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item {{request()->is('chordhub/canciones') ? 'active' : ''}}">
    ...
    <script src="{{asset("templates/userpanel/vendor/jquery/jquery.min.js")}}"></script>
    <script src="{{asset("templates/userpanel/vendor/bootstrap/js/bootstrap.bundle.min.js")}}"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{asset("templates/userpanel/vendor/jquery-easing/jquery.easing.min.js")}}"></script>
